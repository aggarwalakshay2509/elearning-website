...
const Teacher=()=>{
    return (
        ...
        <div class="left">
            ...
            <a href="instructorSign.html"><button type="submit" class="forCourses">Get Started</button></a>
        </div>
        <div class="right">
            <div class="imagePart">
    ...
    <div class="steps">
        ...
        <div class="stepContent">
            <div class="step s1">
                <button class="stepBtn jsStep" id="clk1">Make whole course curriculum</button>
                <button class="jsStep" id="clk1"><i class="fa fa-angle-up updown1"></i></button><br/>
            ...
            <hr/>
            <div class="step s2">
                <button class="stepBtn jsStep" id="clk2">Record all lectures</button>
                <button class="jsStep" id="clk2"><i class="fa fa-angle-down updown2"></i></button><br/>
                <div class="todo" id="todo2">
            ...
            <hr/>
            <div class="step s3">
                <button class="stepBtn jsStep" id="clk3">Upload your course</button>
                <button class="jsStep" id="clk3"><i class="fa fa-angle-down updown3"></i></button><br/>
                <div class="todo" id="todo3">
